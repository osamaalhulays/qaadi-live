...
export const QN21_CRITERIA: QN21Criterion[] = [
  {
    ...
    keywords: ["=", "equation", "formula", "boundary condition"],
  },
  {
    code: "rigor",
    type: "internal",
    ...
    keywords: ["analysis", "derive", "rigorous"],
  },
  {
    code: "dimensional",
    type: "internal",
    ...
    keywords: ["dimension", "units", "dimensional analysis"],
  },
  {
    code: "notation",
    type: "internal",
  ...
  },
  {
    ...
    keywords: ["experiment", "setup", "procedure", "method"],
  },
  {
    code: "calibration",
    type: "internal",
  ...
  },
  {
    ...
    keywords: ["precision", "accuracy", "measurement", "uncertainty"],
  },
  {
    code: "data",
    type: "internal",
    ...
    keywords: ["data analysis", "statistics", "statistical", "dataset"],
  },
  {
    ...
    keywords: ["reproduce", "replicate", "repeat", "reproducible"],
  },
  {
    code: "validation",
    type: "internal",
    ...
    keywords: ["validate", "validation", "comparison", "benchmark"],
  },
  {
    code: "conservation",
    type: "internal",
    ...
    keywords: ["conservation", "law", "conserve", "conservation law"],
  },
  {
    code: "ethics",
    type: "external",
    weight: 8,
    description: "Ethics",
    keywords: ["ethics", "ethical", "consent", "integrity"],
  },
  {
    code: "safety",
    type: "external",
    ...
    keywords: ["safety", "safe", "compliance", "hazard"],
  },
  {
    code: "environmental",
    type: "external",
    ...
    keywords: ["environment", "environmental", "impact", "sustainability"],
  },
  {
    code: "accessibility",
    type: "external",
    ...
    keywords: ["accessibility", "accessible", "inclusive", "inclusive design"],
  },
  {
    code: "privacy",
    type: "external",
    ...
    keywords: ["privacy", "confidential", "data protection", "anonymity"],
  },
  {
    ...
    keywords: ["interdisciplinary", "cross-disciplinary", "integration", "multidisciplinary"],
  },
  {
    code: "communication",
    type: "external",
    ...
    keywords: ["public", "communication", "outreach", "dissemination"],
  },
  {
    code: "engagement",
    type: "external",
    ...
    keywords: ["community", "engagement", "stakeholder", "participation"],
  },
  {
    code: "policy",
    type: "external",
    ...
    keywords: ["policy", "regulation", "compliance", "governance"],
  },
  {
    code: "societal",
    type: "external",
    ...
    keywords: ["societal", "society", "relevance", "social impact"],
  },
];
